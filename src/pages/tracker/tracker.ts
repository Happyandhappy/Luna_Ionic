    ...
    public generateSelfieQ() {
        ...
        if (numSelfies > 0) {
            ...
            for (var i = 0; i < numSelfies; i++){
                ...
                this.items.push({ id: i, name: "Photo #" + (i + 1),selfiepass : '1', selfierecord : '1',selfieattract:'1',selfiecommunicate:'1', descriptions:unitdescriptions,OtherSelfie:'',imgurl:''});
            }
        }
        else {
